...
!(function(a, b) {
    ...
    function a(a, k, l) {
        if (
            i(a) &&
            j(k, "parameters", "object") &&
            j(l, "callback", "function")
        ) {
            for (
                n = h(k),
                    b(v, a),
                ...
                c(p, q, n.seed, n.amount, t, n.iterations);
            (r = new Image()),
                (r.onload = function() {
                    x.drawImage(r, 0, 0),
                        (s = x.getImageData(0, 0, a.width, a.height)),
                        l(s);
                }),
                (r.src = g(p));
        }
    ...
    function d(a, b) {
        var c = "number" == typeof b && 1 > b && b > 0 ? b : 0.1;
    ...
    function g(a) {
        ...
        return (
            0 === b
                ? (e.push(A[(3 & d) << 4]), e.push("=="))
                : 1 === b && (e.push(A[(15 & d) << 2]), e.push("=")),
            e.join("")
        );
    }
    function h(a) {
    ...
    function i(a) {
        return j(a, "image_data", "object") &&
            j(a.width, "image_data.width", "number") &&
            j(a.height, "image_data.height", "number") &&
            j(a.data, "image_data.data", "object") &&
            j(a.data.length, "image_data.data.length", "number") &&
            k(a.data.length, "image_data.data.length", l, "> 0")
            ? !0
            : !1;
    }
    function j(a, b, c) {
...
distortNode(document.getElementById("thist"));
